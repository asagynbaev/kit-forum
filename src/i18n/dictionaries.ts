...
export const dictionaries: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    "hero.venueLine": "МУК · ул. Льва Толстого, 17Б/1",
    ...
    "contacts.row.venue.l2": "Бишкек, ул. Льва Толстого, 17Б/1",
    ...
    "privacyPage.s7.body": "По вопросам обработки персональных данных обращайтесь: ответственный сотрудник ПВТ КР — e.nechaeva@htp.kg; общие запросы — pr@htp.kg; адрес: Кыргызская Республика, г. Бишкек, ул. Льва Толстого, 17Б/1.",
  ...
  ky: {
    ...
    "hero.venueLine": "КЭУ · Лев Толстой көчөсү, 17Б/1",
    ...
    "contacts.row.venue.l2": "Бишкек, Лев Толстой көчөсү, 17Б/1",
    ...
    "privacyPage.s7.body": "Жеке маалыматтарды иштетүү боюнча суроолор боюнча: КР ЖТПнын жооптуу кызматкери — e.nechaeva@htp.kg; жалпы суроо-талаптар — pr@htp.kg; дареги: Кыргыз Республикасы, Бишкек ш., Лев Толстой көч., 17Б/1.",
