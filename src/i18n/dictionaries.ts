...
export const dictionaries: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    "hero.venueLine": "МУК · ул. Льва Толстого, 17А/1",
    ...
    "contacts.row.venue.l2": "Бишкек, ул. Льва Толстого, 17А/1",
    ...
    "pressPage.lead": "Официальные пресс-релизы, итоги и инсайты КИТ Форума.",
    ...
    "pressPage.tag.insight": "Инсайт",
    "pressPage.tag.recap": "Итоги",
    "pressPage.readMore": "Читать полностью",
    "pressPage.collapse": "Свернуть",
    ...
    "privacyPage.s7.body": "По вопросам обработки персональных данных обращайтесь: ответственный сотрудник ПВТ КР — e.nechaeva@htp.kg; общие запросы — pr@htp.kg; адрес: Кыргызская Республика, г. Бишкек, ул. Льва Толстого, 17А/1.",
  ...
  ky: {
    ...
    "hero.venueLine": "КЭУ · Лев Толстой көчөсү, 17А/1",
    ...
    "contacts.row.venue.l2": "Бишкек, Лев Толстой көчөсү, 17А/1",
    ...
    "pressPage.lead": "Расмий пресс-релиздер, КИТ Форумдун жыйынтыктары жана инсайттары.",
    ...
    "pressPage.tag.insight": "Инсайт",
    "pressPage.tag.recap": "Жыйынтык",
    "pressPage.readMore": "Толук окуу",
    "pressPage.collapse": "Жыйыштыруу",
    ...
    "privacyPage.s7.body": "Жеке маалыматтарды иштетүү боюнча суроолор боюнча: КР ЖТПнын жооптуу кызматкери — e.nechaeva@htp.kg; жалпы суроо-талаптар — pr@htp.kg; дареги: Кыргыз Республикасы, Бишкек ш., Лев Толстой көч., 17А/1.",
  ...
  en: {
    ...
    "pressPage.lead": "Official press releases, recaps and insights from KIT Forum.",
    ...
    "pressPage.tag.insight": "Insight",
    "pressPage.tag.recap": "Recap",
    "pressPage.readMore": "Read more",
    "pressPage.collapse": "Collapse",
