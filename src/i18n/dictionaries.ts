...
export const dictionaries: Record<Locale, Record<string, string>> = {
  ru: {
    ...
    "award.q.cowork.concept.label": "Опишите концепцию и уникальность вашего коворкинга",
    "award.q.cowork.concept.ph": "Идея, ценности, целевая аудитория, что делает вас особенными…",
    "award.q.cowork.capacity.label": "Сколько рабочих мест и резидентов в вашем коворкинге?",
    "award.q.cowork.capacity.ph": "Вместимость, количество активных резидентов, офисы…",
    "award.q.cowork.services.label": "Какие дополнительные услуги и события вы предоставляете резидентам?",
    "award.q.cowork.services.ph": "Нетворкинг, ивенты, менторство, инфраструктура…",
    // ── Best Digital Bank
    "award.q.bank.products.label": "Какие цифровые продукты или сервисы выделяют ваш банк?",
    "award.q.bank.products.ph": "Мобильный банк, онлайн-сервисы, уникальные продукты…",
    "award.q.bank.users.label": "Сколько активных пользователей мобильного банкинга?",
    "award.q.bank.users.ph": "MAU, количество транзакций, охват…",
    "award.q.bank.digital.label": "Какие технологии внедрены для улучшения клиентского опыта?",
    "award.q.bank.digital.ph": "AI, биометрия, открытое API, цифровые инновации…",
  ...
  ky: {
    ...
    "award.q.cowork.concept.label": "Коворкингиңиздин концепциясын жана өзгөчөлүгүн сүрөттөңүз",
    "award.q.cowork.concept.ph": "Идея, баалуулуктар, максаттуу аудитория, өзгөчөлүгүңүз…",
    "award.q.cowork.capacity.label": "Коворкингиңизде канча жумуш орну жана резиденттер бар?",
    "award.q.cowork.capacity.ph": "Сыйымдуулук, активдүү резиденттердин саны, кеңселер…",
    "award.q.cowork.services.label": "Резиденттерге кандай кошумча кызматтарды жана иш-чараларды сунуштайсыз?",
    "award.q.cowork.services.ph": "Тармак, иш-чаралар, менторлук, инфраструктура…",
    "award.q.bank.products.label": "Кандай санариптик продуктулар же кызматтар банкыңызды айырмалайт?",
    "award.q.bank.products.ph": "Мобилдик банк, онлайн-кызматтар, уникалдуу продуктулар…",
    "award.q.bank.users.label": "Мобилдик банкингдин активдүү колдонуучуларынын саны канча?",
    "award.q.bank.users.ph": "MAU, транзакциялардын саны, камтуу…",
    "award.q.bank.digital.label": "Кардарлардын тажрыйбасын жакшыртуу үчүн кандай технологиялар киргизилди?",
    "award.q.bank.digital.ph": "AI, биометрика, ачык API, санариптик инновациялар…",
    "award.form.submitError":
  ...
  en: {
    ...
    "award.q.cowork.concept.label": "Describe the concept and uniqueness of your coworking space",
    "award.q.cowork.concept.ph": "Idea, values, target audience, what makes you special…",
    "award.q.cowork.capacity.label": "How many workplaces and residents does your coworking space have?",
    "award.q.cowork.capacity.ph": "Capacity, number of active residents, offices…",
    "award.q.cowork.services.label": "What additional services and events do you provide for residents?",
    "award.q.cowork.services.ph": "Networking, events, mentorship, infrastructure…",
    "award.q.bank.products.label": "What digital products or services distinguish your bank?",
    "award.q.bank.products.ph": "Mobile banking, online services, unique products…",
    "award.q.bank.users.label": "How many active mobile banking users do you have?",
    "award.q.bank.users.ph": "MAU, number of transactions, reach…",
    "award.q.bank.digital.label": "What technologies have been implemented to improve customer experience?",
    "award.q.bank.digital.ph": "AI, biometrics, open API, digital innovations…",
    "award.form.submitError":
